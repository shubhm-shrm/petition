...
.btn{
  ...
  width:100%;
		...
		<main class="mdl-layout__content main_content" style="margin-top:5em;">
		  <?= form_open('login/do_register',['class'=>'form-horizontal'])?>
			<div class="login-form-div mdl-grid mdl-shadow--2dp mdl-color--white-100">	
				...
				<div class="mdl-cell mdl-cell--12-col cell_con">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input class="mdl-textfield__input" type="text" pattern="[a-z]{1,15}$" id="sample2" name="first">
						<label class="mdl-textfield__label" for="sample2">Enter First Name</label>
				...
				<div class="mdl-cell mdl-cell--12-col cell_con">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input class="mdl-textfield__input" type="text" pattern="[a-z]{1,15}$" id="sample2" name="last">
						<label class="mdl-textfield__label" for="sample2">Enter Last Name</label>
						<span class="mdl-textfield__error">Invalid Name...!</span>
			        </div>
			        <div class="col-lg-6">
							<?= form_error('last')?>
				...
				<div class="mdl-cell mdl-cell--12-col  login-btn-con">
					<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary btn">Register</button>
				</div>
				<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet links">
					<a href="<?php echo site_url('login/user_login'); ?>" class="mdl-button--primary">Login now !</a>
				</div>
				<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet links">
